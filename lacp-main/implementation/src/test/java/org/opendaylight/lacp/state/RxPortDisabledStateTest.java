...
public class RxPortDisabledStateTest {
        LacpPort port;
        RxContext context;
        RxPortDisabledState rxState;
        RxState stateObj;
	LacpBpduInfo bpdu;
	...
	bpdu = Mockito.mock(LacpBpduInfo.class);
        ...
        rxState = new RxPortDisabledState();
        stateObj = new RxState();
	stateObj.setStateFlag(LacpConst.RX_STATES.RX_PORT_DISABLED);		
	}
	...
	public void testGetStateFlag() throws Exception {
		assertEquals(LacpConst.RX_STATES.RX_PORT_DISABLED, rxState.getStateFlag());
	}
...
//		rxState.executeStateAction(context, port,bpdu);		
	...
	@Test
	public void testRxPortDisabledState() throws Exception {
		assertEquals(LacpConst.RX_STATES.RX_PORT_DISABLED, rxState.getStateFlag());
	}
}
