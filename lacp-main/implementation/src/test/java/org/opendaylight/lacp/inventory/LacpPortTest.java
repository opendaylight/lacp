...
public class LacpPortTest {
   ...
   @Before
	...
	public void testToString() {
		assertNotNull(lacpPort.toString());
	}
	...
	public void testGetStmStateString() {
		...
		assertNotNull(lacpPort.getStmStateString((short)0x2));
	}
	...
	public void gettersSetters(){
		...
		assertEquals(true,lacpPort.getEnabled(true));//TODO returns the passed argument
